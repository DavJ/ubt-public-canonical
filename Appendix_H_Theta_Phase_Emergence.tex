...
\end{itemize}
The phase dynamics and theta function structure discussed here apply within this complex-time framework.

\textbf{Note on derivatives:} The drift-diffusion operators and complex-time derivatives $\partial/\partial\tau$ used in this appendix are derived from the canonical biquaternion time structure. They represent the restriction of the full biquaternion derivative $\partial/\partial T_B$ to the complex-time slice $\tau = t + i\psi$, not independent definitions.
